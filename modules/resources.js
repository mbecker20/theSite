...
export class MySounds {
    // initializes sounds
    constructor(scene) {
        this.animChange = BF.MakeSound('animChange', 'theSite/resources/animChange.mp3', scene);

        this.blockHit = BF.MakeSound('blockHit', 'theSite/resources/blockHit.mp3', scene, null, {spatialSound: true});

        this.uiClick = BF.MakeSound('uiClick', 'theSite/resources/uiClick.mp3', scene);
    }
}